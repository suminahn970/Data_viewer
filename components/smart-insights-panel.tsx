...
export function SmartInsightsPanel({ data, result }: SmartInsightsPanelProps) {
  ...
  return (
    <Card className="glass-card rounded-3xl h-full flex flex-col">
      {/* 헤더 섹션 한글화 */}
      <div className="px-10 py-8 border-b border-gray-100/50 bg-white/30 backdrop-blur-sm">
        <h2 className="text-xl font-bold text-slate-900 tracking-tight">AI 데이터 인사이트</h2>
      </div>
