...
export function DataCleaningSection({ 
  ...
  return (
    <Card className="glass-card rounded-3xl overflow-hidden h-full flex flex-col">
      <div className="px-10 py-8 border-b border-gray-100/50 flex justify-between items-center bg-white/30 backdrop-blur-sm">
        <div className="flex items-center gap-4">
          <h2 className="text-xl font-bold text-slate-900 tracking-tight text-left">데이터 관리</h2>
